...
tests = [
    ...
    #('path-area-perspective', path_integrator, sun_area, camera_sensor, camera_sensor_spp),    
    #('ptracer-area-perspective', ptracer_integrator, sun_area, camera_sensor, camera_sensor_spp),    
    #('path-directional-perspective', path_integrator, sun_directional, camera_sensor, camera_sensor_spp),    
    #('ptracer-directional-perspective', ptracer_integrator, sun_directional, camera_sensor, camera_sensor_spp),
]
